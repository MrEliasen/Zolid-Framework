...
class admin_editaccount extends AppController
{
	/**
	...
	public function action_updateaccount()
	{
		...
		if( !empty($passquery) )
		{
			$stmt->bindValue(':passwd', password_hash(Misc::data('updateaccount_pass'), PASSWORD_BCRYPT, array('cost' => Configure::get('security/hash_cost') )), PDO::PARAM_STR);
		}
